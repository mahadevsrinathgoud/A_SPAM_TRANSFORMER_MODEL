"""aspam_transformer_model URL Configuration
...
from aspam_transformer_model import settings
...
urlpatterns = [
    ...
    url(r'^Predict_SMSMessage_Type/$', remoteuser.Predict_SMSMessage_Type, name="Predict_SMSMessage_Type"),
    ...
    url(r'^View_SMSMessage_Type_Ratio/$', serviceprovider.View_SMSMessage_Type_Ratio, name="View_SMSMessage_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_SMSMessage_Type/$', serviceprovider.View_Prediction_Of_SMSMessage_Type, name="View_Prediction_Of_SMSMessage_Type"),
