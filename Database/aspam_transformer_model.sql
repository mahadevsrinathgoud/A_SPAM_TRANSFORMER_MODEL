...
--
-- Host: localhost
-- Generation Time: Dec 23, 2021 at 12:59 PM
...
--
-- Database: `aspam_transformer_model`
--
CREATE DATABASE IF NOT EXISTS `aspam_transformer_model` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
('nrfgnfsqgh5dt9cqa0eg4j1ykzw83rpo', 'eyJ1c2VyaWQiOjN9:1n0NaU:Om1A0UXZbYEkPTwEuKXGNuM0KZfFDYXnLRZuSsmgGuc', '2022-01-06 12:52:50.712983'),
...
('svthaqr2thoann1344mar9o8zy51sk2l', 'eyJ1c2VyaWQiOjF9:1n0N9p:RMqTcMSmxcg21bnTffPtvQrP9GY8K1drtMlv8f01tew', '2022-01-06 12:25:17.613291'),
...
CREATE TABLE IF NOT EXISTS `remote_user_aspam_transformer_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `remote_user_aspam_transformer_prediction`
--

INSERT INTO `remote_user_aspam_transformer_prediction` (`id`, `SMS_Message`, `Prediction`) VALUES
(1, 'Free entry in 2 a wkly comp to win FA Cup final tkts 21st May 2005. Text FA to 87121 to receive entry question(std txt rate)T&C''s apply 08452810075over18''s', 'Spam'),
(2, 'I''m gonna be home soon and i don''t want to talk about this stuff anymore tonight, k? I''ve cried enough today.', 'Ham'),
(3, 'URGENT! You have won a 1 week FREE membership in our å£100,000 Prize Jackpot! Txt the word: CLAIM to No: 81010 T&C www.dbuk.net LCCLTD POBOX 4403LDNW1A7RW18', 'Ham'),
(4, 'XXXMobileMovieClub: To use your credit, click the WAP link in the next txt message or click here>> http://wap. xxxmobilemovieclub.com?n=QJKGIGHJJGCBL', 'Ham'),
(5, 'Thanks for your subscription to Ringtone UK your mobile will be charged å£5/month Please confirm by replying YES or NO. If you reply NO you will not be charged', 'Ham'),
(6, 'Urgent UR awarded a complimentary trip to EuroDisinc Trav, Aco&Entry41 Or å£1000. To claim txt DIS to 87121 18+6*å£1.50(moreFrmMob. ShrAcomOrSglSuplt)10, LS1 3AJ', 'Ham'),
(7, 'You are a winner U have been specially selected 2 receive å£1000 or a 4* holiday (flights inc) speak to a live operator 2 claim 0871277810910p/min (18+) ', 'Spam'),
(8, 'Want 2 get laid tonight? Want real Dogging locations sent direct 2 ur mob? Join the UK''s largest Dogging Network bt Txting GRAVEL to 69888! Nt. ec2a. 31p.msg@150p', 'Ham'),
(9, 'Customer service annoncement. You have a New Years delivery waiting for you. Please call 07046744435 now to arrange delivery', 'Spam'),
(10, 'Life is more strict than teacher... Bcoz Teacher teaches lesson &amp; then conducts exam, But Life first conducts Exam &amp; then teaches Lessons. Happy morning. . .', 'Ham'),
(11, 'U 447801259231 have a secret admirer who is looking 2 make contact with U-find out who they R*reveal who thinks UR so special-call on 09058094597', 'Spam'),
(12, 'Hey I am really horny want to chat or see me naked text hot to 69698 text charged at 150pm to unsubscribe text stop 69698', 'Ham');
...
(2, 'Ramesh', 'Ramesh123@gmail.com', 'Ramesh', '9535866270', 'India', 'Karnataka', 'Bangalore'),
...
(15, 'Naive Bayes', '97.66816143497758'),
(16, 'SVM', '97.9372197309417'),
(17, 'Logistic Regression', '97.30941704035875'),
(18, 'Decision Tree Classifier', '98.02690582959642'),
(19, 'Random Forest Classifier', '97.57847533632287'),
(20, 'SGD Classifier', '97.57847533632287'),
(21, 'KNeighborsClassifier', '90.67264573991032');
...
(18, 'Spam', '33.33333333333333'),
(19, 'Ham', '66.66666666666666');
